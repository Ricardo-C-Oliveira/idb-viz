...
const occupation = require("./data/occupation.json");
const economicallyActiveMen = require("./data/economically_active_men.json");
const economicallyActiveWomen = require("./data/economically_active_women.json");
    ...
    return (
      <div>
        <Menu borderless inverted>
          <Menu.Item header className="lettering">
            {" "}Youth Employment in Latin America
          </Menu.Item>
          <Menu.Item position="right" style={{ paddingTop: 25 }}>
            <ModalInfo />
          </Menu.Item>
        </Menu>
            ...
            <Grid.Column>
              ...
              <Grid columns={2} divided style={{ marginRight: 0 }}>
                <Grid.Column>
                  <BarChartCustom
                    name="Industry"
                    data={this.state.industryDataFiltered}
                  />
                </Grid.Column>
                <Grid.Column>
                  <BarChartCustom
                    name="Occupation"
                    data={this.state.occupationDataFiltered}
              ...
              <Grid columns={1} divided style={{ marginRight: 0 }}>
                <Grid.Column>
                  <DonutChartCustom
                    ...
                    data1={this.state.economicallyActiveMenDataFiltered}
                    data2={this.state.economicallyActiveWomenDataFiltered}
                  />
                </Grid.Column>
              </Grid>
            </Grid.Column>
